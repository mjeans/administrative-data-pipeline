...
Read the [executed before/after audit](outputs/report.md) and [R/Stata coverage matrix](docs/implementation-coverage.md). The aggregate report is regenerated by `Rscript scripts/publish_audit.R`; row-level generated output remains ignored.
